...
public class BasicScreen extends ScreenAdapter {
	...
	/**
	 * @return the {@link #position} with the {@link #selectedInterpolation
	...
	public void show() {
		...
		// see how many fields are actually interpolations (for safety; other fields may
		// be added with future)
	...
	public void render(float delta) {
		...
		float bottomLeftX = Gdx.graphics.getWidth() / 2 - graphSize / 2,
				bottomLeftY = Gdx.graphics.getHeight() / 2 - graphSize / 2;
